    ...
    #pragma omp parallel num_threads(2)
    {
        ...
        if (omp_get_thread_num() == 0) {
            ...
            do {
                ...
                Packet p = do_task(genes[i_j_task_id[0]], genes[i_j_task_id[1]], i_j_task_id[2], pxy, pgap, genes_length[i_j_task_id[0]], genes_length[i_j_task_id[1]]);
